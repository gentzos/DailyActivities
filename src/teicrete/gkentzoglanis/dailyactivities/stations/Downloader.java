...
public class Downloader {
	...
	private static String myTag = "Xml File";
	 ...
	 * @param fos
	 *            - a FileOutputStream to save the downloaded file to.
	 ************************************************/
	public static void DownloadFromUrl(String URL, FileOutputStream fos) { // this is the downloader method
		...
		try {
			...
			// keep the start time so we can display how long it took to the
			// Log.
			...
			sleep = System.currentTimeMillis() - startTime;

			Log.d(myTag, "download ready in " + ((sleep)) + " milisec");
		} catch (IOException e) {
			Log.d(myTag, "Error: " + e);
		}
	}
